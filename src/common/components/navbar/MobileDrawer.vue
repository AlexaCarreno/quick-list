<template>
  ...
  <transition name="slide">
    ...
    >
      ...
      <div
        class="flex items-center h-16 justify-between p-3 border-b border-gray-800"
      >
...
const allMenuItems = [
  { label: "Groups", path: "/groups", resource: "groups", action: "read" },
  { label: "Users", path: "/users", resource: "users", action: "read" },
];
